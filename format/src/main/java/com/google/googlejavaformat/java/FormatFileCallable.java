...
class FormatFileCallable implements Callable<FormatFileCallable.Result> {
  ...
  private RangeSet<@org.jetbrains.annotations.NotNull Integer> characterRanges(String input) {
    final RangeSet<@org.jetbrains.annotations.NotNull Integer> characterRanges = TreeRangeSet.create();
